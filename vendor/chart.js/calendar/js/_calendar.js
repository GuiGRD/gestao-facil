...
(function($) {
	...
	var strings = {
		...
		no_events_in_day: 'N�o h� eventos nesse dia.',
		...
		week: 'Semana {0}',
		all_day: 'Dia interiro',
		time: 'Hora',
		events: 'Eventos',
		before_time: 'Fim antes do timeline',
		after_time: 'In�cio depois do timeline',
	...
	Calendar.prototype.getTitle = function() {
		...
		switch(this.options.view) {
			case 'year':
				...
				break;
			case 'month':
				return this.locale.title_month.format(this.locale['mCustom' + p.getMonth()], p.getFullYear());
				break;
			case 'week':
	...
	function showEventsList(event, that, slider, self) {
		...
		setTimeout(function() {
			$('a.event-item').attr('target', '_parent'); // year view || month view || day view
			$('a.cal-event-week').attr('target', '_parent'); // week view
